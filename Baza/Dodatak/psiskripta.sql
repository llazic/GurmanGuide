...
ADD CONSTRAINT XPKAdministrator PRIMARY KEY (IdKorisnik);
...
ALTER TABLE Drzava
ADD CONSTRAINT XPKDrzava PRIMARY KEY (IdDrzava);
...
ALTER TABLE Grad
ADD CONSTRAINT XPKGrad PRIMARY KEY (IdGrad);
...
ALTER TABLE Gurman
ADD CONSTRAINT XPKGurman PRIMARY KEY (IdKorisnik);
...
ADD CONSTRAINT XPKIma_Sastojak PRIMARY KEY (IdJelo,IdSastojak);
...
ALTER TABLE Jelo
ADD CONSTRAINT XPKJelo PRIMARY KEY (IdJelo);
...
ADD CONSTRAINT XPKRecenzija PRIMARY KEY (IdJelo,IdKorisnik);
...
ADD CONSTRAINT XPKRestoran PRIMARY KEY (IdKorisnik);
...
ADD CONSTRAINT XPKSastojak PRIMARY KEY (IdSastojak);
...
ALTER TABLE Slika
ADD CONSTRAINT XPKSlika PRIMARY KEY (IdSlika);
